...
exports.listerPaiementsPassager = async (req, res) => {
    try {
        ...
        console.log(`🔍 [Paiement Controller] Fetching payments for user: ${passagerId}`);
        ...
        console.log(`🔍 [Paiement Controller] Filter:`, filtre);
...
exports.statsPaiementsPassager = async (req, res) => {
    try {
        const passagerId = req.utilisateur._id;
        console.log(`🔍 [Paiement Controller] Fetching stats for user: ${passagerId}`);
