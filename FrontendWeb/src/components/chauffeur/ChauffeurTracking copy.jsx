                                ...
                                >
                                    <div className="grid grid-cols-2 md:grid-cols-1 gap-4">
                                        ...
                                        <div>
                                            ...
                                            >
                                                {trip.pickupStatus === 'approaching' && 'EN APPROCHE'}
                                                {trip.pickupStatus === 'arrived' && 'SUR PLACE'}
                                                {trip.pickupStatus === 'picked_up' && 'À BORD'}
                                                {trip.pickupStatus === 'pending' && (currentPickupTripId === trip.id ? 'EN COURS' : 'REJOINDRE')}
                                                {!['approaching', 'arrived', 'picked_up', 'pending'].includes(trip.pickupStatus) && (currentPickupTripId === trip.id ? 'EN COURS' : 'REJOINDRE')}
                                            </Button>
                                        </div>
                                    </div>
                                </motion.div>
