                        ...
                        <div className="relative">
                            ...
                            {isEditing && (
                                <button
                                    ...
                                    className="absolute bottom-2 right-2 w-10 h-10 bg-primary-600 text-white rounded-full flex items-center justify-center shadow-lg hover:bg-primary-700 transition-colors border-2 border-white dark:border-gray-800 animate-in zoom-in duration-200"
                                >
