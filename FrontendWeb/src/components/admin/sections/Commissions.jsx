...
import EditPaymentModal from './commissions/EditPaymentModal';
  ...
  return (
    <div className="space-y-4 md:space-y-6 px-2">
      ...
      <PaymentDetailsModal
        ...
        onEdit={() => setModalState(prev => ({ ...prev, showDetails: false, showEdit: true }))}
        onProcess={() => setModalState(prev => ({ ...prev, showDetails: false, showProcess: true }))}
      />
      ...
      {/* Commission Chart */}
      <CommissionsCharts evolutionData={evolutionData} repartitionData={repartitionData} chartHeight={chartHeight} />
      ...
      <Card>
        ...
        <CardContent>
          <ResponsiveCommissionsTable
            payments={payments}
            isMobile={isMobile}
            loadingList={loadingList}
            onViewDetails={handleViewDetails}
            onProcess={(payment) => setModalState(prev => ({ ...prev, showProcess: true, selectedPayment: payment }))}
